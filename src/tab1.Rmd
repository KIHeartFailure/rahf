...
tab1 <- tab1func(data = pdata %>% filter(shf_ef_cat2 == "LVEF <40%", casecontrol == "Case"))
tab2 <- tab1func(data = pdata %>% filter(shf_ef_cat2 == "LVEF <40%", casecontrol == "Control"))
tab3 <- tab1func(data = pdata %>% filter(shf_ef_cat2 == "LVEF =>40%", casecontrol == "Case"))
tab4 <- tab1func(data = pdata %>% filter(shf_ef_cat2 == "LVEF =>40%", casecontrol == "Control"))
...
footnote(
  default_kable(taball,
    ...
    landscape() %>%
    add_header_above(c(" " = 1, "Case" = 3, "Control" = 3, "Case" = 3, "Control" = 3)) %>%
...
tab1 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFrEF", casecontrol == "Case"))
tab2 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFrEF", casecontrol == "Control"))
tab3 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFmrEF", casecontrol == "Case"))
tab4 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFmrEF", casecontrol == "Control"))
tab5 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFpEF", casecontrol == "Case"))
tab6 <- tab1func(data = pdata %>% filter(shf_ef_cat == "HFpEF", casecontrol == "Control"))
...
footnote(
  default_kable(taball,
    ...
    landscape() %>%
    add_header_above(c(" " = 1, "Case" = 3, "Control" = 3, "Case" = 3, "Control" = 3, "Case" = 3, "Control" = 3)) %>%
